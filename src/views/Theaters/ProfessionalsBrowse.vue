<template>
    <div>
        <div class="bg-blue-50 px-10 py-8 mx-auto text-center">
            <p class="text-2xl md:text-3xl font-bold mb-2">Theatre Professionals</p>
        ...
        <div class="mx-auto max-w-7xl px-6 text-center lg:px-8 mb-12">
            ...
            <li v-for="person in people" :key="person.name" class="rounded-2xl px-8 py-10 border-2 border-gray-100">
