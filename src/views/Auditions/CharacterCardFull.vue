  ...
  <div class="overflow-hidden bg-white shadow-md sm:rounded-lg p-0 mb-10">
    <div class="bg-blue-900">
      <div class="px-4 py-6 sm:px-6 d-flex flex-row">
        <span>
          <div class="text-base font-bold leading-7 text-blue-100">Name</div>
    ...
    <div class="px-2">
      <dl class="grid grid-cols-1 sm:grid-cols-3 mb-0">
        <div class="border-t border-gray-100 px-4 py-3 sm:col-span-1 sm:px-0">
          <dt class="text-sm leading-6 text-gray-900">Gender</dt>
          <dd class="mt-1 text-base leading-6 text-gray-700 sm:mt-2">{{ character.gender }}</dd>
        </div>
        <div class="border-t border-gray-100 px-4 py-3 sm:col-span-1 sm:px-0">
          <dt class="text-sm leading-6 text-gray-900">Age</dt>
          <dd class="mt-1 text-base leading-6 text-gray-700 sm:mt-2">{{ character.age }}</dd>
        </div>
        <div class="border-t border-gray-100 px-4 py-3 sm:col-span-1 sm:px-0">
          <dt class="text-sm leading-6 text-gray-900">Ethnicity</dt>
          <dd class="mt-1 text-base leading-6 text-gray-700 sm:mt-2">{{ character.ethnicity }}</dd>
        </div>
