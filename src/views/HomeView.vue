          ...
          >
            ...
            <div class="card-body">
              <div class="mb-1">
                ...
                <div>
                  <p class="mb-2 text-base">
                    Uncover innovative #LifeHacks designed to streamline your daily routine and boost productivity. We
                    aim to empower you with simple yet effective strategies for success!
                  </p>
                </div>
              </div>
            </div>
