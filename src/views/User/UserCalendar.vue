    ...
    return {
      days: [
        ...
        { date: "2023-05-02", isCurrentMonth: true, events: [] },
        {
          ...
          isCurrentMonth: true,
          events: [
            { id: 1, name: "Design review", time: "10AM", datetime: "2023-05-03T10:00", href: "#" },
            { id: 2, name: "Sales meeting", time: "2PM", datetime: "2023-05-03T14:00", href: "#" },
          ],
        },
        ...
        { date: "2023-05-06", isCurrentMonth: true, events: [] },
        {
          date: "2023-05-07",
          isCurrentMonth: true,
          events: [{ id: 3, name: "Date night", time: "6PM", datetime: "2023-05-08T18:00", href: "#" }],
        },
        ...
        { date: "2023-05-11", isCurrentMonth: true, events: [] },
        {
          ...
          isCurrentMonth: true,
          isToday: true,
          events: [{ id: 6, name: "Sam's birthday party", time: "2PM", datetime: "2023-05-25T14:00", href: "#" }],
        },
        ...
        { date: "2023-05-21", isCurrentMonth: true, events: [] },
        {
          ...
          isSelected: true,
          events: [
            { id: 4, name: "Maple syrup museum", time: "3PM", datetime: "2023-05-22T15:00", href: "#" },
            { id: 5, name: "Hockey game", time: "7PM", datetime: "2023-05-22T19:00", href: "#" },
          ],
        },
        ...
        {
          date: "2023-06-04",
          events: [{ id: 7, name: "Cinema with friends", time: "9PM", datetime: "2023-06-04T21:00", href: "#" }],
        },
