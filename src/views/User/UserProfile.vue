      ...
      <div class="border-b border-gray-900/10 pb-12">
          ...
          <div class="w-full md:w-1/2 grid flex flex-wrap flex">
            <div class="flex-wrap flex">
              <div class="w-full lg:w-1/2 p-3">
                <label for="pronouns" class="block text-sm font-medium leading-6 text-gray-900">Pronouns:</label>
                <div class="mt-2">
                  <input
                    type="text"
                    name="pronouns"
        ...
        <!-- <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="sm:col-span-2">
            <label for="postal-code" class="block text-sm font-medium leading-6 text-gray-900">Height</label>
            <div class="flex">
              <div class="mr-3">
                <DropdownSelect placeholder="ft" :options="[1, 2, 3, 4, 5, 6, 7]" />
              </div>
          ...
          <div class="sm:col-span-2">
            <label for="eye-color" class="block text-sm font-medium leading-6 text-gray-900">Eye Color</label>
            <div class="mt-2">
              <input
                type="text"
                name="eye-color"
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <textarea
                ...
                rows="3"
                class="px-2 placeholder-gray-400 block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2 flex items-center gap-x-3">
              ...
              <button
                type="button"
                class="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
              >
                Change
              </button>
            </div>
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <select
                ...
                class="pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              >
