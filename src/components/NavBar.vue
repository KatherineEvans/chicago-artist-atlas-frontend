        ...
        <Menu as="div" class="relative inline-block text-left">
          <div>
            <MenuButton>
              ...
              <div
                v-if="userHeadshot"
                class="bg-cover bg-center inline-block h-10 w-10 overflow-hidden rounded-full"
                :style="{ 'background-image': 'url(' + userHeadshot + ')' }"
              ></div>
              <span v-else class="inline-block h-10 w-10 overflow-hidden rounded-full bg-gray-100 bg-cover">
